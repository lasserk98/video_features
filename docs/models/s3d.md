...
| `checkpoint_path`                       | `null`                                | Path to a custom S3D checkpoint (`.pth/.pt/.ckpt`). If set, the model is loaded from this path instead of the bundled Kinetics 400 weights.                                       |
